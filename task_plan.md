...
| GraphQL PR recheck returned `UNKNOWN` for PR 1447 and HTTP 503 for PR 370 | 1 | No write occurred; retain the earlier complete REST evidence where both PRs were `open`, non-draft, and `mergeable_state: clean`, plus the independently successful check-run evidence. |
